...
export default async function handler(req,res){
  ...
  const quote=new URLSearchParams({travelQuote:'1',cta:'hotel_minisite_preview',destino:destinationName});
  ...
  const pdfUrl=offer?`https://${PUBLIC_HOST}/oferta/${encodeURIComponent(offer.id)}.pdf`:'';
  ...
  <header class="site-header"><div class="container header-inner"><a class="brand" href="/"><img class="brand-logo" src="/assets/images/trhoncal-travel-logo.svg" alt="Trhoncal Travel"></a><nav class="nav"><a href="/#destinos">Destinos</a><a href="/cuando-viajar/">Cuándo viajar</a><a href="/#promociones">Ofertas</a><a href="/#cotizar">Solicita tu viaje</a></nav><a class="btn btn-outline" href="https://wa.me/523329335952">WhatsApp</a></div></header>
  ...
  <main class="hotel-v2-main">
   ...
   ${offer?`<section class="hotel-v2-actions"><div class="container"><div class="hotel-v2-action-card"><strong>Guárdala, compártela o envíala a quien viaje contigo.</strong><div class="hotel-v2-action-buttons"><button class="hotel-v2-mini primary" type="button" data-native-share>Compartir promoción</button>${pdfUrl?`<a class="hotel-v2-mini gold" href="${esc(pdfUrl)}">Descargar PDF</a>`:''}<a class="hotel-v2-mini" href="${esc(wa)}" target="_blank">WhatsApp</a><a class="hotel-v2-mini" href="${esc(mail)}">Correo</a><button class="hotel-v2-mini" type="button" data-copy>Copiar enlace</button></div></div></div></section>`:''}
