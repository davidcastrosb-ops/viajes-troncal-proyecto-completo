...
<nav class="hub-context-nav" aria-label="Navegación del destino"><div class="container hub-context-nav-inner"><a href="/#destinos">← Todos los destinos</a><a href="/#promociones">Ver todas las ofertas →</a></div></nav>
<main>
...
<section class="hub-more"><div class="container"><div class="hub-more-card"><div><span class="eyebrow">Sigue explorando</span><h2>¿Quieres conocer otro destino?</h2><p>Compara otros lugares o revisa las promociones vigentes sin salir de Trhoncal Travel.</p></div><div class="hub-more-actions"><a class="btn btn-outline" href="/#destinos">Explorar todos los destinos →</a><a class="btn btn-primary" href="/#promociones">Ver ofertas vigentes →</a></div></div></div></section>
